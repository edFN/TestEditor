...
const SearchPanelList = ({onChange}) => {
    return (
        <div className='small-search-panel'>
            <img src={process.env.PUBLIC_URL + "/icon/search.svg"} className="search-icon-small"/>
            <TextFieldUIBase type={'tf-text-grey tf-field-standart tf-background-white'} placeHolder={"Введите текст для поиска"} onChangeAction={(e)=>onChange(e)}/>
